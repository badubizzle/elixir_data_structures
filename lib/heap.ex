defmodule ListUtils do
    ...
    def heapify(l, index,t) when t in [:max, :min] do
        ...
        case t do
            :max ->
                max_index = if left_index <= last_index and Enum.at(l, left_index) > Enum.at(l, index) do
                    left_index
                else
                    index
                end
            ...
            :min ->
                min_index = if left_index <= last_index and Enum.at(l, left_index) < Enum.at(l, index) do
                    left_index
                else
                    index
                end
